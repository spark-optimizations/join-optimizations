...
bothTimePlot <- plot_both_time(plot_both_time_d, "a) Fixed Size Small RDD", "Big RDD Size (MB)", "Time (sec)")
vsTimePlot <- plot_vs_time(plot_vs_time_d, "b) Fixed Size Big RDD", "Small RDD Size (MB)", "Time (sec)")
